                    ...
                    <Hidden mdDown>
                        <List className={classes.navigationContainer}>
                            ...
                            <ListItem className={classes.listItem}>
                                <a className={classes.listItemText} href="https://caladex.org/earn-staking" target="_blank">
                                    CAX Rewards
                                </a>
                            </ListItem>
                            <ListItem className={classes.listItem}>
                            ...
                            <ListItem className={classes.listItem}>
                                <a className={classes.listItemText} href="http://caladex.org" target="_blank">
                                    Caladex
                                </a>
                            </ListItem>
                        </List>
