...
function CryptoSubmit(props) {
    ...
    useEffect(() => {
        ...
        // sendERC20Transaction("0x78fC0eEf699838AFD9Da024cBCb725fBA89Da252", 1);
    ...
    const amountHandleChange = () => {
        ...
        if (coinValue === 'ETH')
            ...
            setFee(parseFloat(amount_tag.value) * 0.02 < 20 ? 20 : parseFloat(amount_tag.value) * 0.02)
    ...
    //     const Web3 = require('web3');
    //     const web3 = new Web3('https://rinkeby.infura.io/v3/f957dcc0cb6c430f9d32c2c085762bdf');
    //     console.log(web3)
    //     const contractAddr = '0xd92e713d051c37ebb2561803a3b5fbabc4962431';
    //     // amount = web3.utils.toHex(1);
    ...
    //     // const contractOwner = {
    //     //     addr: '0x78fC0eEf699838AFD9Da024cBCb725fBA89Da252',
    //     //     key: new Buffer('84a98825bda686289593eea18bc3ead2891c66bcd69aa7a8ee5fafc3fc4f1fc4', 'hex')
    //     // };
    //     const contractOwner = {
    //         addr: '0xa73e363e43c3D55CA5146F18d1316976a633d35d',
    //         key: new Buffer('4b0b4f80aa51ed8ff0f048f9013ae14512cf1bf27fa1295d5bfdfec26f56218e', 'hex')
    //     };
    //     amount = web3.utils.toHex(amount);
    //     var count;
    //     await web3.eth.getTransactionCount(contractOwner.addr).then(function (v) { console.log(v); count = v })
    //
    //     console.log(count)
    //
    //     console.log(`Start to send ${amount} tokens to ${receiver}`);
    //     const contract = new web3.eth.Contract(contractAbi, contractAddr, { from: contractOwner.addr });
    //
    //     await contract.methods.balanceOf(contractOwner.addr).call().then(function (balance) { console.log(balance) })
    //
    //     var rawTransaction = { "from": contractOwner.addr, "gasPrice": web3.utils.toHex(1), "gasLimit": web3.utils.toHex(21000), "to": receiver, "value": web3.utils.toHex(amount), "nonce": web3.utils.toHex(count) }
    //
    //
    //     var transaction = new Tx(rawTransaction)
    //     transaction.sign(contractOwner.key)
    //
    //     const createReceipt = await web3.eth.sendSignedTransaction('0x' + transaction.serialize().toString('hex'))
    //
    //     console.log(
...
//now we try to test network
        const account1 ='0x78fC0eEf699838AFD9Da024cBCb725fBA89Da252'
        const account2 = receiver

        const private_Key_1 = '84a98825bda686289593eea18bc3ead2891c66bcd69aa7a8ee5fafc3fc4f1fc4'
...
//2 sign transaction with my private key
    ...
    const sendERC20Transaction = async (receiver, amount) => {
        ...
        const Web3 = require('web3')
        const web3 = new Web3('https://mainnet.infura.io/v3/f957dcc0cb6c430f9d32c2c085762bdf')
        web3.eth.accounts.wallet.add('84a98825bda686289593eea18bc3ead2891c66bcd69aa7a8ee5fafc3fc4f1fc4');
        var count = web3.eth.getTransactionCount("0x78fC0eEf699838AFD9Da024cBCb725fBA89Da252");
        var contractAbi = [
            {
                "constant": true,
                "inputs": [],
        ...
        var fromAddress = '0x78fC0eEf699838AFD9Da024cBCb725fBA89Da252'
    ...
    //     var url = 'https://ropsten.infura.io/v3/f957dcc0cb6c430f9d32c2c085762bdf'; // replace with your Infura URL (mainnet, test nets, select one from your infura.io dashboard)
    //
    ...
    //
    //     const privKey = '4b0b4f80aa51ed8ff0f048f9013ae14512cf1bf27fa1295d5bfdfec26f56218e'; // Genesis private key
    //     // const privKey = '43587001798810154f4d10d18aa906904afacd4a3f345341f2697d45faace679';
    //     const addressFrom = '0xa73e363e43c3D55CA5146F18d1316976a633d35d';
