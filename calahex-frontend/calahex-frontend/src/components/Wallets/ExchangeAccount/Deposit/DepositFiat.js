                    ...
                    <div>
                        ...
                        {method == 0 && <div className={classes.fiatSecondBody}>
                            <div className={classes.warnBox}>
                                <h4>
                                    For this payment method, {currency}  is automatically stored as USDT in a {currency == 'USD' ? '1:0.90' : (currency == 'EUR' ? '1:1.04' : '1:0.50')} ratio.
                                </h4>
                            </div>
                            <span>Amount</span>
                            ...
                            <div>
                                ...
                                <div className={classes.fiatSecondBodyFee}>
                                    ...
                                    <div><strong>
                                        {Number(parseFloat(amount) * (currency == 'USD' ? 0.90 : (currency == 'EUR' ? 1.04 : (currency == 'AWG' ? 0.50 : 0)))).toFixed(3)} USDT</strong></div>
                                </div>
                            </div>
