          ...
          <Grid container className={classes.container} data-aos={'fade-up'}>
            ...
            <Grid item md={6} className={classes.cardContent}>
              <div className={classes.cardText}>
                ...
                <h3 className={classes.cardDescription}>Buy, sell and trade. Buy ETH/USDT with your debit and credit card from your Calahex Wallet. Get your crypto wallet going with 200+ spot trading pairs.</h3>
              </div>
          ...
          <Grid container className={clsx(classes.container, classes.bgGray)} data-aos={'fade-up'}>
            <Grid item md={6}  className={classes.cardContent}>
              ...
              <div className={classes.center}>
                ...
                <a href="http://www.caladex.org" target="_blank">
                  <Button
                  color="default"
                  variant="contained"
                  size="small"
            ...
            <Grid item md={6}  className={classes.cardContent}>
              ...
              <div className={classes.center}>
                {/* <Link to={"/comming-soon"} className={classes.textDecoNone}>
                  ...
                  <a href="https://caladex.org/earn-staking" target="_blank">
                  <Button
                    color="default"
                    variant="contained"
                    size="small"
