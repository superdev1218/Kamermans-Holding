...
Route::group(['middleware' => ['get.menu']], function () {
    ...
    Route::get('/get_live_price', [HomeController::class, 'get_live_price'])->name('get_live_price');
    ...
    Route::group(['middleware' => ['role:admin']], function () {
        ...
        Route::get('/tokens/whitepaper/{id}', [TokensController::class, 'whitepaper'])->name('tokens.whitepaper');
        Route::put('/tokens/{id}/approve', [TokensController::class, 'approve'])->name('tokens.approve');
