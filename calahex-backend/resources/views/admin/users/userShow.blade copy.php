                                    ...
                                    <table class="table table-responsive-sm table-striped">
                                        ...
                                        <tbody>
                                            @foreach(json_decode($balances) as $balance)
                                                <tr>
                                                    <td class="text-wrap">{{$balance->token_symbol}}</td>
                                                    <td class="text-wrap">{{$balance->exchange_balance}}</td>
                                                    <td class="text-wrap">{{$balance->margin_balance}}</td>
                                                    <td class="text-wrap">{{$balance->futures_balance}}</td>
                                                    <td class="text-wrap">{{$balance->savings_balance}}</td>
                                                    <td class="text-wrap">{{$balance->pool_balance}}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
